      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              href="/get-started"
              className="bg-blue-400 hover:bg-blue-500 text-slate-900 px-4 py-2 rounded-md text-sm font-medium transition-colors"
            >
              {t('getStarted')}
            </Link>
          </div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className={`px-2 py-1 text-xs rounded ${
                        locale === 'vi' ? 'bg-blue-100 text-blue-800' : 'text-gray-600'
                      }`}
                    >
                      VI
                    </button>
                    <button
                      onClick={() => handleLanguageChange('en')}
                      className={`px-2 py-1 text-xs rounded ${
                        locale === 'en' ? 'bg-blue-100 text-blue-800' : 'text-gray-600'
                      }`}
                    >
                      EN
                    </button>
