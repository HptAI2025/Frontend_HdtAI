          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-gray-700 font-medium">{t('introduction.tagline')}</span>
              </div>
            </div>
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl p-8 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">{t('introduction.innovation')}</h3>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Values */}
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-r from-teal-500 to-teal-600 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('values.title')}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('activities.consulting.title')}</h3>
              <p className="text-gray-600 text-sm">{t('activities.consulting.description')}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('activities.development.title')}</h3>
              <p className="text-gray-600 text-sm">{t('activities.development.description')}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('activities.training.title')}</h3>
              <p className="text-gray-600 text-sm">{t('activities.training.description')}</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">{t('activities.automation.title')}</h3>
              <p className="text-gray-600 text-sm">{t('activities.automation.description')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('commitments.innovation.title')}</h3>
              <p className="text-gray-600">{t('commitments.innovation.description')}</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('commitments.partnership.title')}</h3>
              <p className="text-gray-600">{t('commitments.partnership.description')}</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">{t('commitments.sustainability.title')}</h3>
              <p className="text-gray-600">{t('commitments.sustainability.description')}</p>
            </div>
          </div>
        </div>
      </section>
